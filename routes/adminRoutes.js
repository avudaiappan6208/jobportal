...
adminrouter.put('/companies/:companyid/assignrecruiter/:recruitersid',admin.checkauth,admin.allowrules['admin'],adminController.assignrecruiter);
adminrouter.delete('/companies/:companyid/assignrecruiter/:recruitersid',admin.checkauth,admin.allowrules['admin'],adminController.removerecruiter);
// manage jobs
